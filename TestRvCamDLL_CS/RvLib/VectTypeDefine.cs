...
namespace RvLib.VectTypeDefine
{
    ...
    public enum TQueryObject : int
    {
        qoObject =0, qoBitmap, qoObjectDistance, qoFreeDistance
    }
    ...
    {
        leNone =0, leShift, leRotate, 
        leMirrorX, leMirrorY, leScale,
    ...
    public enum TCompensateMode : int
    {
        cmNonCompensate=0,
        cmCompensate,
        cmReverCompensate
    ...
    public unsafe struct TVectSimpleShape
    {
        ...
        {
            if (!ClsDelphiEquivalent.In(polyType, [TVectSimpleShapeType.vstPolyLine, TVectSimpleShapeType.vstPolygon]))
                return;
